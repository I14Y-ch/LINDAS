...
STATUSES = os.environ.get("STATUSES", "Qualified,Standard,PreferredStandard").split(",")  # "Recorded"
...
EXCLUDED_IDS = (
    []
)  # ["0c4f39ae-8217-42ba-882f-2a0ca35129b2","08dbd475-4eb5-d54c-9877-a44b5598e96e", "08dbf0ae-69e8-4cb6-b660-983acf60cf62", "08dc23e1-34e0-de58-8181-b8736ba536a7", "08dc23db-ce0c-6a92-9716-4f1f482fc414", "08dc23de-ca54-4f1b-bd37-27fdf75391ea", "08dbdf8d-017b-c4e0-954d-3ee7307096d3"]
...
I14Y_SEARCH_URL = os.environ.get("I14Y_SEARCH_URL", "https://api.i14y.admin.ch/api/search")
